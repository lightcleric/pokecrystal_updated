...
MonMenuIcons:
	...
	db ICON_BULBASAUR   ; RHYPERIOR
	db ICON_BULBASAUR   ; NUZLEAF
	db ICON_BULBASAUR   ; SHIFTRY
	...
	db ICON_PIKACHU     ; LITWICK
	db ICON_CLEFAIRY    ; LAMPENT
	db ICON_JIGGLYPUFF  ; CHANDELURE
	...
	db ICON_MONSTER     ; EELEKTRIK
	db ICON_MONSTER     ; EELEKTROSS
	db ICON_MONSTER     ; ABSOL
	...
	db ICON_HUMANSHAPE  ; SLIGGOO
	db ICON_HUMANSHAPE  ; GOOMY
