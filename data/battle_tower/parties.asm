...
; BattleTowerMons group 1
	...
	db SNORLAX
	db MIRACLEBERRY
	db HEADBUTT, PROTECT, SELFDESTRUCT, SURF
	dw 0 ; OT ID
	bigdt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 3
	...
	db GOLDUCK
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, ICE_BEAM, SUBMISSION
	dw 0 ; OT ID
	bigdt 27000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 4
	...
	db PORYGON2
	db NO_ITEM
	db BODY_SLAM, TRI_ATTACK, PSYBEAM, THIEF
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db EXEGGUTOR
	db BRIGHTPOWDER
	db SLAM, STOMP, psych_up, CONFUSION
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db ELECTABUZZ
	db KINGS_ROCK
	db LIGHT_SCREEN, THUNDERPUNCH, SWIFT, SELFDESTRUCT
	dw 0 ; OT ID
	bigdt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 6
	...
	db GLACEON
	db GOLD_BERRY
	db ICE_BEAM, IRON_TAIL, PROTECT, BLIZZARD
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SANDSLASH
	db SCOPE_LENS
	db EARTHQUAKE, SLASH, HYPER_BEAM, SELFDESTRUCT
	dw 0 ; OT ID
	bigdt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 8
	...
	db SNORLAX
	db LEFTOVERS
	db REST, BELLY_DRUM, SELFDESTRUCT, EARTHQUAKE
	dw 0 ; OT ID
	bigdt 512000 ; Exp
	; Stat exp
	bigdw 60000
